...
Revision ID: 2e46ea4b1965
Revises: 9e4e099786ca
Create Date: 2022-09-25 20:08:16.473686
...
revision = '2e46ea4b1965'
down_revision = '9e4e099786ca'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('education_level', sa.Enum('HIGH_SCHOOL', 'UNDERGRADUATE', 'DIPLOMA', 'CERTIFICATE', name='educationlevel'), nullable=True),
    sa.Column('certificate_path', sa.String(length=1000), nullable=True),
    ...
    sa.Column('fine_date', sa.TIMESTAMP(), nullable=True),
    sa.Column('amount_fined', sa.Numeric(precision=65, scale=2), nullable=True),
    ...
    sa.Column('rating', sa.Integer(), server_default='5', nullable=True),
    sa.Column('status', sa.Enum('unassigned', 'bid_status', 'progress', 'reassigned', 'completed', 'revision', 'finished', 'paid', 'disputed', 'cancelled', 'deleted', name='status'), server_default='unassigned', nullable=False),
    ...
    sa.Column('read_status', sa.Enum('TRUE', 'FALSE', name='readstatus'), server_default='FALSE', nullable=True),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], ),
    ...
    sa.Column('order_id', sa.Integer(), nullable=True),
    sa.Column('job_status', sa.Enum('unassigned', 'bid_status', 'progress', 'reassigned', 'completed', 'revision', 'finished', 'paid', 'disputed', 'cancelled', 'deleted', name='status'), nullable=True),
    sa.Column('rating', sa.Integer(), server_default='5', nullable=True),
    sa.Column('amount_paid', sa.Numeric(precision=65, scale=2), server_default='0', nullable=True),
    sa.Column('amount_fined', sa.Numeric(precision=65, scale=2), server_default='0', nullable=True),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('last_edited', sa.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], ),
