...
Revision ID: 1a8a97dbbc9f
Revises: 88169e30b14b
Create Date: 2022-02-24 01:32:49.308543
...
revision = '1a8a97dbbc9f'
down_revision = '88169e30b14b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('bidding_status',
    sa.Column('id', sa.Integer(), nullable=False),
